...
from models.admin.plant_model import get_plants, get_plant_data, update_plant_process
...
#READ
@admin_route.route("/user_management", methods=["GET"])
def user_management():
    users = get_users()
    print(users)
...
#UPDATE
@admin_route.route("/action_process", methods=["POST"])
def action_process():
